  ...
  return (
    <AnimatePresence>
      <motion.a
        ...
        className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-brand-brown shadow-[0_10px_30px_-10px_rgba(37,211,102,0.6)] animate-pulse-glow hover:shadow-[0_15px_40px_-8px_rgba(37,211,102,0.7)] sm:bottom-8 sm:right-8 sm:h-16 sm:w-16"
      >
        <svg
          viewBox="0 0 32 32"
